...
import com.example.h314gm.coolweather.gson.Forecast;
import com.example.h314gm.coolweather.gson.Weather;
import com.example.h314gm.coolweather.service.AutoUpdateService;
...
public class WeatherActivity extends AppCompatActivity {
    ...
    public void requestWeather(final String weatherId)
    {
        ...
        String weatherUrl = "http://www.guolin.tech/api/weather?cityid="+weatherId+"&key=cf4e0031d34145f0a6b5548b1a148b6a";
    ...
    private void showWeatherInfo(Weather weather)
    {
        ...
        for (Forecast forecast:weather.forecastList)
        {
            ...
            //Log.d("WeatherActivity:",forecast.date+
                    //"!!"+forecast.more.info+"@@"+forecast.temperature.max+"%%"+forecast.temperature.min);
